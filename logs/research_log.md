...
Today, we have real results. run_001 and run_002 represent the entire 355 prompts being ran through Haiku 4.5 and Sonnnet 4.6. These two were used because they were relatively cheap, yet are still very powerful models, and so can give some frame of reference for the current state of the experiment and model capability.
...
There are a couple of levers I'm hoping to pull for the next few experiments before moving up to the more frontier models. 
